...
import { getStoreKeyModuleValues, getStoreModuleName, getStoreModule, getStoreStateWithModules, appendNewObjectValues, appendNewValues, } from './helpers';
...
var handleGettersValuesSet = function (store, state, setGettersValues) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                getters = getStoreKeyModuleValues(store, 'getters');
            ...
            case 1:
                ...
                getterNames.forEach(function (getterPath) {
                    ...
                    if (typeof prevValues[getterPath] === 'undefined') {
                        ...
                        if (!isEqual) {
                            var newValue = appendNewValues(value, oldValue);
