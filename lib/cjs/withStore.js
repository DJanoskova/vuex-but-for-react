    ...
    var actions = react_1.useMemo(function () {
        ...
        actionNames.forEach(function (actionName) {
            ...
            if (moduleNames.length === 1) {
                ...
                var moduleMutations_1 = filterObjectModuleKeys(mutations, actionName);
                var moduleActions_1 = filterObjectModuleKeys(actions, actionName);
                console.log(mutations);
                console.log(actions);
                console.log(moduleMutations_1);
                console.log(moduleActions_1);
                values[actionName] = function () {
                    var args = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        args[_i] = arguments[_i];
                    }
                    return originalFn.apply(void 0, __spreadArray([{ mutations: moduleMutations_1, actions: moduleActions_1 }], args));
                };
            }
        });
        return values;
